...
// Mirrors apps/api's MessengerPlatformAdapter.verifyChallenge() — keep in
// sync if that logic changes. Edge verifies locally (holds its own copy of
