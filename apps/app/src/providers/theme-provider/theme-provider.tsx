...
function getDefaultValue(cookies: Record<string, string>): ThemeOption {
  const persisted = cookies[THEME_KEY] as ThemeOption;
...
export const ThemeProvider = ({ children }: PropsWithChildren) => {
  const [cookies, setCookie] = useCookies([THEME_KEY]);
  const [state, setState] = useState<ThemeOption>(getDefaultValue(cookies));
