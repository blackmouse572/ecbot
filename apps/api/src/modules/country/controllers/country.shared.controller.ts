...
@ApiTags('modules.shared.country')
@Controller({
    version: '1',
    path: '/country',
})
export class CountrySharedController {
    constructor(
    ...
    private async getCountryList({
        ...
        _offset,
        _order,
    }: PaginationListDto): Promise<IResponsePaging<CountryListResponseDto>> {
    ...
    async listPublic(
        ...
        return await this.getCountryList(pagination);
    }
}
