...
/**
 * Instagram is declared in ENUM_ACCOUNT_TYPE but not implemented — every method
 ...
 */
@Injectable()
export class InstagramPlatformAdapter extends BaseStubPlatformAdapter {
    readonly type = ENUM_ACCOUNT_TYPE.INSTAGRAM_PAGE;
}
