...
/**
 * TikTok Shop is declared in ENUM_ACCOUNT_TYPE but not implemented — every method
 ...
 */
@Injectable()
export class TiktokPlatformAdapter extends BaseStubPlatformAdapter {
    readonly type = ENUM_ACCOUNT_TYPE.TIKTOK_SHOP;
}
