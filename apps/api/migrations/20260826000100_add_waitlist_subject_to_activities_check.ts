...
export class Migration20260826000100_add_waitlist_subject_to_activities_check extends Migration {
    override async up(): Promise<void> {
        // Allow WAITLIST as an activity subject (proactive - ENUM_POLICY_SUBJECT.WAITLIST
        // exists but the check constraint was never synced, same class of drift as action).
        this.addSql(
