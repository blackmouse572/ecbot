...
export function ScrollArea({
  ...
  return (
    <ScrollAreaPrimitive.Root
      className={clx("size-full min-h-0", className)}
      {...props}
    >
...
export function ScrollBar({
  ...
  ...props
}: ScrollAreaPrimitive.ScrollAreaScrollbarProps): React.ReactElement {
  return (
    ...
    >
      <ScrollAreaPrimitive.Thumb
        className="relative flex-1 rounded-full bg-ui-fg-base/20"
