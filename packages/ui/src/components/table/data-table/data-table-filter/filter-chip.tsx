  ...
  return (
    <div className="bg-ui-bg-field transition-fg shadow-borders-base text-ui-fg-subtle flex cursor-default select-none items-stretch overflow-hidden rounded-md">
      ...
      <div className="flex w-full items-center overflow-hidden">
        ...
        {/* Always render the trigger, even before a value has been picked \u2014
        otherwise a filter with no value yet (or one whose auto-remove timer
        got orphaned) is a dead chip with no way to reopen its popover. */}
