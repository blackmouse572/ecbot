import { ArrowDownTray, Spinner, Trash } from "@medusajs/icons";
import { IconButton, Text } from "@medusajs/ui";
import { type ActionGroup, ActionMenu } from "../action-menu";
  ...
  return (
    <div className="shadow-elevation-card-rest bg-ui-bg-component transition-fg rounded-md px-3 py-2">
      <div className="flex flex-row items-center justify-between gap-2">
        ...
        {!loading && onRemove && (
          <IconButton variant="transparent" onClick={onRemove}>
            <Trash />
...
// Tailwind's zinc scale — the thumbnail's gradients are just zinc-100..900.
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor={ZINC_100} />
          <stop offset="1" stopColor={ZINC_200} />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor={ZINC_200} />
          <stop offset="1" stopColor={ZINC_300} />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor={ZINC_600} />
          <stop offset="1" stopColor={ZINC_400} />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor={ZINC_900} />
          <stop offset="1" stopColor={ZINC_600} />
        </linearGradient>
      </defs>
    </svg>
  );
