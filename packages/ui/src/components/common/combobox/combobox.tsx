...
import { genericForwardRef } from "./forward-ref";
  ...
  return (
    ...
    >
      ...
      <PrimitiveComboboxPopover
        ...
        aria-busy={isPending}
      >
        {results.map(({ value, label, labelNode, disabled }) => (
          ...
          >
            ...
            <PrimitiveComboboxItemValue className="txt-compact-small min-w-0 flex-1">
              {labelNode ?? label}
