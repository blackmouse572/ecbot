...
export const FileUpload = ({
  ...
  onUploaded,
  ...rest
}: FileUploadProps & React.HTMLAttributes<HTMLDivElement>) => {
  ...
  return (
    <div {...rest}>
      <button
        ...
        className={clx(
          "bg-ui-bg-component border-ui-border-strong transition-fg group flex w-full flex-col justify-center items-center gap-y-2 rounded-lg border border-dashed p-8",
          "min-h-8 h-full ",
