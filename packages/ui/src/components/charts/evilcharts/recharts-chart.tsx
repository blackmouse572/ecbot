...
// Vendored from EvilCharts (https://evilcharts.com, github.com/legions-developer/evilcharts),
// src/registry/{ui,charts}. MIT License, Copyright (c) 2026 Gurbinder — see NOTICE.
// Local edits are limited to imports: `cn` is @medusajs/ui's `clx`, and registry
// paths are relative. Keep it that way so upstream updates drop in.
// This file also has two fixes: `onResize` (ResponsiveContainer's
// `(width, height)` callback) went to the <div> via the rest spread, where React
// types it as a DOM event — it is now passed to the ResponsiveContainer; and one
// in-bounds index is asserted for noUncheckedIndexedAccess.

import * as RechartsPrimitive from "recharts";
import { clx as cn } from "@medusajs/ui";
...
interface ChartContainerProps
  extends
    Omit<React.ComponentProps<"div">, "children" | "onResize">,
    Pick<
